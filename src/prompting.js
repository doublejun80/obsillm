...
function buildProviderPrompt(prompt, retrieval) {
    ...
    sections.push("Write in Markdown. Be explicit when information comes from the web. When vault notes are relevant, mention note titles naturally in the answer.");
    return {
